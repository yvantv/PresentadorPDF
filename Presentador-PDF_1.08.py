...
class VentanaControl(QMainWindow):
    ...
    def cargar_configuracion(self):
        ...
        # 3. Cargar el último archivo cargado
...
if __name__ == "__main__":
    ...
    # Identificadores para guardar en el Registro de Windows
    app.setOrganizationName("MiEmpresa")
    app.setApplicationName("PresentadorPDF")

    window = VentanaControl()
    
    # Filtro global de navegación por teclado
