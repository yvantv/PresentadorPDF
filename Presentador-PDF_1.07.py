...
class VentanaControl(QMainWindow):
    ...
    def guardar_pdf_anotado(self):
        ...
        for num_pagina in range(len(self.doc_pdf)):
            ...
            rect_pdf = pagina.rect  # Dimensiones reales de la página PDF

            trazos = trazos_por_pagina.get(num_pagina, [])
            if not trazos:
                continue

            # Escalar desde las coordenadas de pantalla a las del PDF real
            ...
            for trazo in trazos:
                ...
                # Mapear los puntos al tamaño original del PDF
                puntos_pdf = [
                ...
                # Proporcionar el grosor respecto al ancho de la página
...
if __name__ == "__main__":
    ...
    # --- INSTALACIÓN DEL FILTRO DE NAVEGACIÓN GLOBAL ---
