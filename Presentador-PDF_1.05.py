...
class LayerAnotaciones(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.color_lapiz = QColor(230, 30, 30)       # Rojo por defecto
        self.color_resaltador = QColor(255, 235, 59)  # Amarillo por defecto
    ...
    def tiene_anotaciones(self):
        """Devuelve True si existe al menos un trazo realizado en alguna página."""
    ...
    def reiniciar_anotaciones(self):
        """Limpia por completo todo el historial de trazos para todas las páginas."""
        self.trazos_por_pagina.clear()
        self.trazo_actual.clear()
        self.update()

    def get_color_actual(self):
        """Retorna el color de la herramienta que está activa actualmente."""
    ...
    def set_color(self, nuevo_color):
        """Asigna el nuevo color a la herramienta activa actualmente."""
...
class VentanaControl(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Vista Previa para el Moderador (Configurada para no auto-expandir el layout)
        ...
        # --- CORRECCIÓN CLAVE ---
        self.lbl_preview.setScaledContents(True)  # Escala el Pixmap dentro de los límites fijos del Label
        self.lbl_preview.setMinimumSize(1, 1)     # Permite que el Label se ajuste libremente sin forzar límites crecientes
    ...
    def renderizar_pagina(self):
        ...
        # Asignar a pantalla de proyección (proyector)
        self.proyector.capa_anotaciones.pagina_actual = self.pagina_actual
        self.proyector.mostrar_pixmap(pixmap)
        
        # --- CORRECCIÓN EN VISTA PREVIA ---
        # Directamente asignamos el pixmap; setScaledContents(True) se encarga de adaptarlo de forma fija
