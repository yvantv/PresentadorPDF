...
class KeyNavigationFilter(QObject):
    """Intercepta teclas de navegación y herramientas sin importar el foco."""
...
class VentanaControl(QMainWindow):
    ...
    def actualizar_paleta_ui(self):
        """Actualiza el aspecto de los 4 botones de la paleta reciente."""
    ...
    def registrar_nuevo_color(self, color):
        """Añade un color al historial de los 4 recientes sin duplicar el primero."""
        if color.name() in [c.name() for c in self.colores_recientes]:
            # Moverlo al frente si ya existía
    ...
    def actualizar_ui_herramientas(self):
        ...
        # Resaltar la herramienta activa visualmente
