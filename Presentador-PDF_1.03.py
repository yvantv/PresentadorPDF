...
class LayerAnotaciones(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # --- NUEVO: Colores independientes por defecto ---
    ...
    def mouseReleaseEvent(self, event):
        if event.button() == Qt.MouseButton.LeftButton and self.modo in ['pen', 'highlighter']:
            ...
            # Guardar trazo con su propio color y grosor congelados
    ...
    def paintEvent(self, event):
        ...
        for trazo in trazos_a_dibujar:
            ...
            if trazo['modo'] == 'pen':
                ...
                # Aplica transparencia (Alpha = 100) al color asignado al resaltador
...
class VentanaControl(QMainWindow):
    def __init__(self):
        ...
        self.actualizar_ui_herramientas()  # Estado inicial del botón de color/grosor
    ...
    def actualizar_ui_herramientas(self):
        """Sincroniza el botón de color y el spinbox de grosor con la herramienta activa."""
        capa = self.proyector.capa_anotaciones
        color = capa.get_color_actual()
        
        # 1. Actualiza el estilo del botón de color
        ...
        # 2. Actualiza el valor del spinbox de grosor
        grosor = capa.grosor_resaltador if capa.modo == 'highlighter' else capa.grosor_lapiz
        self.spin_grosor.blockSignals(True)  # Evitar disparar eventos mientras actualizamos el valor
